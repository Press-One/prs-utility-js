...
describe('Utility', function () {
  it('recover privateKey', async function () {
    ...
    assert.equal(privateKey, '6e204c62726a19fe3f43c4ca9739b7ffa37e4a3226f824f3e24e00a5890addc6');
  });

  it('keccak256', async function () {
    const message = 'hello prs';
    const hash = utility.keccak256(message);
    assert.equal(hash, '647df39ad889e83cc0b9b65375672d1bfe282565c564d3d553a435bf80e67d92');
  });
  ...
  it('privateKeyToAddress', async function () {
    ...
    assert.equal(address, '758ea2601697fbd3ba6eb6774ed70b6c4cdb0ef9');
  });
